<template>
    ...
    <div class="md:w-6/12 mx-auto p-8 md:p-12 rounded-lg shadow-md">
    ...
    <img src="../assets/images/vank.PNG" alt="">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div class="w-full">
          <button
            type="submit"
            class="px-6 py-2 w-full text-white bg-black rounded-md shadow hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Post Add
          </button>
        </div>
